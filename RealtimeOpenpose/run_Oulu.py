...
class Ui_MainWindow(QtWidgets.QWidget):
    ...
    def set_ui(self):
        ...
        self.button_mode_3 = QtWidgets.QPushButton(u'Micro-gesture recognition OFF') # action recognition button
...
#        self.label_move.raise_()
        self.setWindowTitle(u'Online Body Estimation and Micro-gesture Recognition system (Oulu University)')
    ...
    def button_event(self):
        ...
        if sender == self.button_mode_1 and self.timer_camera.isActive():
            if self.__flag_mode != 1:
                ...
                self.button_mode_3.setText(u'Micro-gesture recognition OFF')
            else:
                self.__flag_mode = 0
            ...
            if self.__flag_mode != 3:
                ...
                self.button_mode_1.setText(u'Openpose OFF')
                self.button_mode_2.setText(u'Action recognition OFF')
                self.button_mode_3.setText(u'Micro-gesture recognition ON')
            else:
                self.__flag_mode = 0
                self.button_mode_3.setText(u'Micro-gesture recognition OFF')
...
#                print(humans)
                ...
                self.infoBox.setText(u'Micro-gesture recognition on')
                humans = poseEstimator.inference(show)
                ori = np.copy(show)
                show, joints, bboxes, xcenter, sk= TfPoseEstimator.get_skeleton(show, humans, imgcopy=False)
                height = show.shape[0]
